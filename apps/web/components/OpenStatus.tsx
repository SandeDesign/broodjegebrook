...
export function OpenStatus({ service, className, variant = "pill" }: OpenStatusProps) {
  ...
  return (
    <span className={cn(
      ...
      status.isOpen
        ? "bg-emerald-500/20 text-emerald-300 border-emerald-400/50 shadow-[0_0_18px_rgba(16,185,129,0.25)]"
        : "bg-red-500/20 text-red-300 border-red-400/50 shadow-[0_0_18px_rgba(239,68,68,0.25)]",
      className,
    )}>
      <span className={cn(
        "inline-block h-2 w-2 rounded-full",
